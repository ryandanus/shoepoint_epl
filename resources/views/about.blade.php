    ...
    <div class="container my-5 py-5">
        <div class="row d-flex align-items-center">
            <div class="col-md-6 text-center">
                <div class="img-container main-logo-container">
                    <img src="{{ asset('/assets/img/logo@0.5x.png') }}" alt="Logo Shoepoint" class="about-logo">
                </div>
            </div>
            <div class="col-md-6">
                <h1 class="about-title"><strong>ABOUT US</strong></h1>
                <h3 class="about-subtitle">Shoes is our passion.</h3>
                <p class="about-paragraph mt-3 text-justify">
                    Shoepoint is a shoe cleaning startup founded by Nabil.
                    He is passionate about shoes and all about them.
                    He started to think that the demand of shoe cleaning is bigger than the supply.
                    He then found his own startup at a young age in 2018. Shoepoint itself primarily doing shoe cleaning,
                    but also have additional service such as shoe unyellowing and repaint service (yes we do that here, too!)
                </p>
                <p class="about-paragraph text-justify">
                    Connect with us at our social media below, or click <a href="{{ url('/contact-us') }}">here</a> to contact us directly through the website.
                </p>
                <div class="social-media-icons">
                    {{-- INSTRAGRAM --}}
                    <a href="https://bit.ly/IGShoepoint" target="_blank">
                        <svg class="icons about-icons" version="1.1" id="Instagram" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <a href="https://bit.ly/LINEShoepoint" target="_blank">
                        <svg class="icons about-icons" version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1080 1080" xml:space="preserve">
                            <g id="g7930">
                    ...
                    <a href="https://bit.ly/WAShoepoint" target="_blank">
                        <svg class="icons about-icons" viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="row d-flex align-items-center mt-5">
            <div class="col-md-6">
                <iframe src="https://www.google.com/maps/embed?pb=!4v1608986412402!6m8!1m7!1sqa7cCjVErK2gYcl0Ohjndg!2m2!1d-7.287735246728034!2d112.8007083033537!3f229.4991622848642!4f-0.6439478048994403!5f1.6593411562688591" width="100%" height="350" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" class="p-1"></iframe>
            </div>
            <div class="col-md-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4844.3084120419735!2d112.79980189970271!3d-7.286829330393257!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x838dcbbbf02396eb!2sShoepoint!5e0!3m2!1sid!2sid!4v1608986099783!5m2!1sid!2sid" width="100%" height="350" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" class="p-1"></iframe>
            </div>
        </div>
    </div>
